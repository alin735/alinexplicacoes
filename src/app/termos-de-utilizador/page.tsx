    ...
    <>
      ...
      <main className="pt-20 min-h-screen bg-[#f5f5f5] px-4 py-10">
        <section className="max-w-4xl mx-auto bg-white rounded-2xl shadow-md p-6 sm:p-8">
          <h1 className="text-3xl font-bold text-[#000000] mb-2">Termos de utilizador</h1>
          ...
          <div className="space-y-6 text-sm sm:text-base text-gray-700 leading-relaxed">
            <section>
              <h2 className="text-lg font-semibold text-[#000000] mb-2">1. Âmbito</h2>
              <p>
                Estes termos regulam o uso da plataforma MatemáticaTop, incluindo marcações, cronogramas,
                conteúdos de apoio e comunicação com o utilizador.
              </p>
            </section>

            <section>
              <h2 className="text-lg font-semibold text-[#000000] mb-2">2. Conta do utilizador</h2>
              <p>
            ...
            <section>
              <h2 className="text-lg font-semibold text-[#000000] mb-2">3. Utilização da plataforma</h2>
              <p>
            ...
            <section>
              <h2 className="text-lg font-semibold text-[#000000] mb-2">4. Marcações e pagamentos</h2>
              <p>
            ...
            <section>
              <h2 className="text-lg font-semibold text-[#000000] mb-2">5. Comunicações por email</h2>
              <p>
            ...
            <section>
              <h2 className="text-lg font-semibold text-[#000000] mb-2">6. Proteção de dados</h2>
              <p>
            ...
            <section>
              <h2 className="text-lg font-semibold text-[#000000] mb-2">7. Alterações aos termos</h2>
              <p>
            ...
            <section>
              <h2 className="text-lg font-semibold text-[#000000] mb-2">8. Contacto</h2>
              <p>
