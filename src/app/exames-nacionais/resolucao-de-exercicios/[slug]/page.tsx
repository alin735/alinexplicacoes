    ...
    <>
      ...
      <main className="min-h-screen bg-[#f5f5f5] pt-28">
        <div className="max-w-5xl mx-auto px-4 pb-16">
          ...
          <section className="mt-6 overflow-hidden rounded-2xl border border-black/15 bg-white shadow-sm">
            ...
            <div className="p-6 sm:p-8">
              <p className="text-xs font-semibold uppercase tracking-[0.2em] text-[#111111] mb-4">
          ...
          <section className="mt-6">
            {post.media_type === 'tiktok' && tiktokEmbedHtml ? (
              ...
              <div className="overflow-hidden rounded-2xl border border-black/15 bg-white p-4 shadow-sm">
                <video controls preload="metadata" className="w-full rounded-2xl" src={post.video_url} />
              </div>
            ) : null}
          </section>
