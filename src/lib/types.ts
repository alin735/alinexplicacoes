...
export const SCHOOL_YEARS = ['7º-9º', '10º', '11º', '12º', 'Preparação para Exame'] as const;
...
// Base price for individual classes (19€/h = 1900 cents)
export const LESSON_PRICE = 1900;
export const LESSON_PRICE_DISPLAY = '19,00€';
